  ...
  return (function(t) {
            ...
            [
              ...
              function(t, i) {
                ...
                while (x < h.length) {
                  ...
                  if (
                    null === S ||
                    (_ = p(s(b.lastIndex + (g ? 0 : x)), h.length)) === w
                  )
                    x = c(h, x, m);
                  else {
                    if ((k.push(h.slice(w, x)), k.length === A)) return k;
                    for (var E = 1; E <= S.length - 1; E++)
                      if ((k.push(S[E]), k.length === A)) return k;
                    x = w = _;
                  }
                }
                return k.push(h.slice(w)), k;
              }
            ]
          );
        },
    ...
    2266: function(t, e, n) {
      var r = n("825a"),
        ...
        l = (t.exports = function(t, e, n, l, f) {
          ...
          m = h.next;
          while (!(y = m.call(h)).done)
            if (
              ((g = c(h, b, y.value, l)),
              "object" == typeof g && g && g instanceof s)
            )
              return g;
          return new s(!1);
        });
      ...
      t.exports = function(t, e) {
        ...
        if (((l = g ? r : m ? r[v] || u(v, {}) : (r[v] || {}).prototype), l))
          for (f in e) {
            if (
              ((d = e[f]),
              t.noTargetGet ? ((p = i(l, f)), (h = p && p.value)) : (h = l[f]),
      ...
      var r,
        ...
        Y = function(t, e) {
          ...
          if ("[" == e.charAt(0)) {
            ...
            if (((n = V(e.slice(1, -1))), !n)) return M;
            t.host = n;
          } else if (W(t)) {
            if (((e = v(e)), I.test(e))) return M;
            if (((n = G(e)), null === n)) return M;
            t.host = n;
          } else {
            if (z.test(e)) return M;
            for (n = "", r = d(e), i = 0; i < r.length; i++) n += Z(r[i], J);
            t.host = n;
          }
        },
        G = function(t) {
          ...
          for (n = [], r = 0; r < e; r++) {
            ...
            if (
              ...
              if (!(10 == o ? L : 8 == o ? B : P).test(i)) return t;
              a = parseInt(i, o);
            }
            n.push(a);
          }
          ...
          while (l <= o.length) {
            switch (((a = o[l]), s)) {
                ...
                if (a && (N.test(a) || "+" == a || "-" == a || "." == a))
                  ...
                  (h = ""),
                    "file" == t.scheme
                      ...
                      : "/" == o[l + 1]
                      ? ((s = lt), l++)
                      : ((t.cannotBeABaseURL = !0), t.path.push(""), (s = _t));
                }
                break;
              case ct:
              ...
              case ht:
                ...
                break;
              case dt:
                if (((s = pt), "/" != a || "/" != h.charAt(l + 1))) continue;
                l++;
                break;
              case pt:
                if ("/" != a && "\\" != a) {
                ...
                if (!C.test(a)) {
                  if (
                    ...
                    if ("" != h) {
                      var A = parseInt(h, 10);
                      if (A > 65535) return R;
                      (t.port = W(t) && A === H[t.scheme] ? null : A), (h = "");
                    }
                    if (n) return;
                    s = xt;
                    continue;
        ...
        Mt = function(t) {
          ...
          if (void 0 !== i)
            if (i instanceof Mt) e = k(i);
            else if (((n = Ot((e = {}), String(i))), n)) throw TypeError(n);
          if (((n = Ot(u, a, null, e)), n)) throw TypeError(n);
          var c = (u.searchParams = new A()),
            s = w(c);
      ...
      if (
        (o &&
          c(Rt, {
            ...
            origin: Gt(Nt),
            protocol: Gt(Ct, function(t) {
              var e = k(this);
              Ot(e, String(t) + ":", at);
            }),
            username: Gt(Tt, function(t) {
              var e = k(this),
                n = d(String(t));
              if (!tt(e)) {
                e.username = "";
            ...
            hostname: Gt(Pt, function(t) {
              var e = k(this);
              e.cannotBeABaseURL || Ot(e, String(t), mt);
            }),
            port: Gt(It, function(t) {
              var e = k(this);
              tt(e) ||
                ((t = String(t)), "" == t ? (e.port = null) : Ot(e, t, yt));
            }),
            pathname: Gt(zt, function(t) {
              var e = k(this);
              e.cannotBeABaseURL || ((e.path = []), Ot(e, t + "", xt));
            }),
            search: Gt(Ut, function(t) {
              var e = k(this);
              (t = String(t)),
                "" == t
                  ? (e.query = null)
        ...
        Vt &&
          s(Mt, "createObjectURL", function(t) {
            return Vt.apply(b, arguments);
          }),
          Ft &&
            s(Mt, "revokeObjectURL", function(t) {
    ...
    "4df4": function(t, e, n) {
      ...
      t.exports = function(t) {
        ...
        if (
          ...
          for (e = u(p.length), n = new v(e); e > A; A++)
            (d = y ? m(p[A], A) : p[A]), c(n, A, d);
        else
          for (
            f = b.call(p), h = f.next, n = new v();
            !(l = h.call(f)).done;
            A++
          )
            (d = y ? o(f, m, [l.value, A], !0) : l.value), c(n, A, d);
        return (n.length = A), n;
      };
    },
    "50c4": function(t, e, n) {
    ...
    "5fb2": function(t, e, n) {
      ...
      var r = 2147483647,
        ...
        w = function(t) {
          ...
          var n,
            ...
            d = 0,
            v = s;
          for (n = 0; n < t.length; n++) (u = t[n]), u < 128 && e.push(m(u));
          var w = e.length,
            x = w;
          w && e.push(f);
          while (x < c) {
            ...
            for (n = 0; n < t.length; n++)
              (u = t[n]), u >= h && u < k && (k = u);
            var _ = x + 1;
            if (k - h > g((r - d) / _)) throw RangeError(p);
            for (d += (k - h) * _, h = k, n = 0; n < t.length; n++) {
              if (((u = t[n]), u < h && ++d > r)) throw RangeError(p);
              if (u == h) {
                for (var S = d, E = i; ; E += i) {
                  var O = E <= v ? o : E >= v + a ? a : E - v;
                  if (S < O) break;
                  var M = S - O,
                    R = i - O;
                  e.push(m(b(O + (M % R)))), (S = g(M / R));
                }
                e.push(m(b(S))), (v = A(d, _, x == w)), (d = 0), ++x;
              }
            }
            ++d, ++h;
          }
      ...
      t.exports = function(t) {
        ...
        for (e = 0; e < i.length; e++)
          (n = i[e]), r.push(h.test(n) ? "xn--" + w(n) : n);
        return r.join(".");
      };
    },
    "60da": function(t, e, n) {
      ...
      (u[v] = !0),
        (t.exports =
          ...
          function(t, e) {
            ...
            return (
              null !== t
                ? ((g[d] = i(t)), (n = new g()), (g[d] = null), (n[v] = t))
                : (n = A()),
              void 0 === e ? n : o(n, e)
            );
          });
    ...
    "7dd0": function(t, e, n) {
      ...
      t.exports = function(t, e, n, l, d, w, x) {
        ...
        var k,
          ...
          M = !1,
          R = t.prototype,
          j = R[g] || R["@@iterator"] || (d && R[d]),
          N = (!v && j) || E(d),
          C = ("Array" == e && R.entries) || j;
        if (
          (C &&
            ((k = o(C.call(new t()))),
            p !== Object.prototype &&
              ...
              (f ||
                o(k) === p ||
                (a ? a(k, p) : "function" != typeof k[g] && c(k, g, A)),
              u(k, O, !0, !0),
              f && (h[O] = A))),
          d == y &&
            j &&
          ...
          if (
            ...
            for (S in _) (v || M || !(S in R)) && s(R, S, _[S]);
          else
            r(
              {
                target: e,
        ...
        function t() {
          ...
          try {
            ...
            var n,
              ...
              o = /.*at [^(]*\((.*):(.+):(.+)\)$/gi,
              a = /@([^@]*):(\d+):(\d+)\s*$/gi,
              u = o.exec(d.stack) || a.exec(d.stack),
              c = (u && u[1]) || !1,
              s = (u && u[2]) || !1,
            ...
            for (var h = 0; h < f.length; h++) {
              if ("interactive" === f[h].readyState) return f[h];
              if (f[h].src === c) return f[h];
              if (c === l && f[h].innerHTML && f[h].innerHTML.trim() === i)
                return f[h];
            }
            return null;
          }
    ...
    9861: function(t, e, n) {
      ...
      var r = n("23e7"),
        ...
        z = function(t) {
          return encodeURIComponent(t).replace(L, I);
        },
        U = function(t, e) {
          if (e) {
            var n,
      ...
      u(
        F,
        {
          ...
          getAll: function(t) {
            Y(arguments.length, 1);
            for (
              var e = M(this).entries, n = t + "", r = [], i = 0;
              i < e.length;
              i++
            )
        ...
        a(
          ...
          function() {
            var t,
              ...
              r = 0;
            while (r < e.length)
              (t = e[r++]), n.push(z(t.key) + "=" + z(t.value));
            return n.join("&");
          },
          {
            enumerable: !0
                ...
                return (
                  arguments.length > 1 &&
                    ...
                    g(e) &&
                      ((n = e.body),
                      p(n) === S &&
                        ((r = e.headers ? new k(e.headers) : new k()),
                        r.has("content-type") ||
                          r.set(
                            "content-type",
          ...
          concat: function(t) {
            ...
            for (e = -1, r = arguments.length; e < r; e++)
              if (((o = -1 === e ? a : arguments[e]), b(o))) {
                if (((i = c(o.length)), h + i > v)) throw TypeError(g);
                for (n = 0; n < i; n++, h++) n in o && s(f, h, o[n]);
              } else {
          ...
          splice: function(t, e) {
            ...
            if (
              (0 === w
                ...
                : 1 === w
                ? ((n = 0), (r = b - A))
                : ((n = w - 2), (r = v(p(o(e), 0), b - A))),
              b + n - r > g)
            )
              throw TypeError(m);
            for (l = c(y, r), f = 0; f < r; f++)
              (h = A + f), h in y && s(l, f, y[h]);
            if (((l.length = r), n < r)) {
              for (f = A; f < b - r; f++)
                (h = f + r), (d = f + n), h in y ? (y[d] = y[h]) : delete y[d];
              for (f = b; f > b - r + n; f--) delete y[f - 1];
            } else if (n > r)
              for (f = b - r; f > A; f--)
                (h = f + r - 1),
                  (d = f + n - 1),
                  h in y ? (y[d] = y[h]) : delete y[d];
            for (f = 0; f < n; f++) y[f + A] = arguments[f + 2];
    ...
    a4d3: function(t, e, n) {
      ...
      var r = n("23e7"),
        ...
        ft = function(t) {
          ...
          return (
            !(this === X && f(W, e) && !f($, e)) &&
            (!(n || !f(this, e) || !f(W, e) || (f(this, U) && this[U][e])) || n)
          );
        },
        ht = function(t, e) {
          var n = g(t),
          ...
          if (n !== X || !f(W, r) || f($, r)) {
            var i = q(n, r);
            return (
              !i || !f(W, r) || (f(n, U) && n[U][r]) || (i.enumerable = !0), i
            );
          }
        },
        dt = function(t) {
      ...
      J[Y][G] || O(J[Y], G, J[Y].valueOf), P(J, D), (N[U] = !0);
    },
    a640: function(t, e, n) {
      "use strict";
      var r = n("d039");
    ...
    a9e3: function(t, e, n) {
        ...
        w = function(t) {
          ...
          if ("string" == typeof s && s.length > 2)
            if (((s = g(s)), (e = s.charCodeAt(0)), 43 === e || 45 === e)) {
              ...
              for (o = s.slice(2), a = o.length, u = 0; u < a; u++)
      ...
      if (o(m, !y(" 0o1") || !y("0b1") || y("+0x1"))) {
        for (
          ...
          u(y, (x = _[S])) && !u(k, x) && v(k, x, p(y, x));
        (k.prototype = b), (b.constructor = k), a(i, m, k);
      }
    },
    ab13: function(t, e, n) {
      var r = n("b622"),
    ...
    b622: function(t, e, n) {
      ...
      t.exports = function(t) {
        return (
          o(s, t) || (u && o(l, t) ? (s[t] = l[t]) : (s[t] = f("Symbol." + t))),
          s[t]
        );
      };
    },
          ...
          return function(d, p, v, g) {
            for (
              var m,
                ...
                k = 0,
                _ = g || u,
                S = e ? _(d, x) : n ? _(d, 0) : void 0;
              x > k;
              k++
            )
              if ((h || k in A) && ((m = A[k]), (y = w(m, k, b)), t))
                if (e) S[k] = y;
                else if (y)
                  switch (t) {
                    case 3:
    ...
    e6cf: function(t, e, n) {
      ...
      var r,
        ...
        X = F,
        J = "process" == b(G),
        K = !!(Y && Y.createEvent && s.dispatchEvent),
        ...
        et = N(L, function() {
          ...
          var e = U.resolve(1),
            ...
            r = (e.constructor = {});
          return (r[B] = n), !(e.then(function() {}) instanceof n);
        }),
        nt =
          et ||
          !x(function(t) {
          ...
          if (!e.notified) {
            ...
            S(function() {
              ...
              while (r.length > a) {
                ...
                try {
                  f
                    ? (o || (e.rejection === tt && ct(t, e), (e.rejection = $)),
                      !0 === f
                        ? (u = i)
                        : (p && p.enter(),
                          (u = f(i)),
        ...
        at = function(t, e) {
          _.call(s, function() {
            ...
            if (
              i &&
              ((n = R(function() {
                J ? G.emit("unhandledRejection", r, t) : ot(q, t, r);
              })),
              (e.rejection = J || ut(e) ? tt : $),
              n.error)
            )
              throw n.value;
          });
        ...
        ct = function(t, e) {
          _.call(s, function() {
            J ? G.emit("rejectionHandled", t) : ot(Q, t, e.value);
          });
        },
        st = function(t, e, n, r) {
          return function(i) {
            ...
            try {
              ...
              i
                ? S(function() {
                    ...
                    try {
                      i.call(n, st(ft, t, r, e), st(lt, t, r, e));
                    } catch (o) {
                      lt(t, r, o, e);
                    }
                  })
                : ((e.value = n), (e.state = H), it(t, e, !1));
            } catch (o) {
              lt(
                t,
                {
      ...
      et &&
        ((U = function(t) {
          y(this, U, L), m(t), r.call(this);
          var e = P(this);
          try {
            t(st(ft, this, e), st(lt, this, e));
          } catch (n) {
            lt(this, e, n);
          }
        }),
        ...
        (i = function() {
          var t = new r(),
            e = P(t);
          (this.promise = t),
            (this.resolve = st(ft, t, e)),
            (this.reject = st(lt, t, e));
        }),
        (M.f = F = function(t) {
    ...
    fb15: function(t, e, n) {
          ...
          return n(
            ...
            [
                    ...
                    directives: [
                      {
                        name: "show",
                        rawName: "v-show",
                        value: t.showSelectedBox,
                        expression: "showSelectedBox"
                      }
                    ],
                    ref: "selectedBox",
                    attrs: {
                      id: "selectedBox",
                      width: t.seleBox.width,
                      height: t.seleBox.height,
                      transform:
                        "translate(" + t.seleBox.x + "," + t.seleBox.y + ")"
                    }
                  })
                ]
              ),
              ...
              n(
                  ...
                  directives: [
                    {
                      name: "show",
                      rawName: "v-show",
                      value: t.showContextMenu,
                      expression: "showContextMenu"
                    }
                  ],
                  ref: "menu",
                  style: {
                    top: t.contextMenuY + "px",
                    left: t.contextMenuX + "px"
                  },
                  attrs: {
                    id: "menu",
                    tabindex: "0"
                ...
                t._l(t.contextMenuItems, function(e, r) {
                  return n(
                    "div",
                    {
                      key: r,
                      ...
                      on: {
                        click: function(n) {
                          !e.disabled && t.clickMenu(e.name);
                        }
                      }
                    },
                    [n("div", [t._v(t._s(e.title))])]
                  );
                }),
                0
              ),
              n(
                "div",
                {
                  staticClass: "buttonList right-bottom"
                },
                [
                  n(
                    "button",
              ...
              n(
                "div",
                {
                  staticClass: "buttonList top-right"
                },
                [
                  n(
                    "button",
                            ...
                            t._l(t.optionList, function(e, r) {
                              return n(
                                "div",
                                {
                                  ...
                                  class:
                                    "option " +
                                    (r === t.selectedOption ? "select" : "") +
                                    " " +
                                    (e.disabled ? "disabled" : ""),
                                  on: {
                                    click: function(n) {
                                      !e.disabled && (t.selectedOption = r);
                                    }
                                  }
                                },
                                [
      ...
      function b(t, e) {
        return !e || ("object" !== m(e) && "function" !== typeof e) ? y(t) : e;
      }
      function A(t) {
        var e = g();
        return function() {
...
***************************************************************************** */
      ...
      function D(t) {
        ...
        var i = Object.getPrototypeOf(t.prototype),
          o = i instanceof _.a ? i.constructor : _.a,
          a = o.extend(e);
        return G(a, t, o), N() && C(a, t), a;
      }
      var Y = {
        prototype: !0,
        arguments: !0,
          ...
          if (!Y[r]) {
            ...
            if (!i || i.configurable) {
              ...
              if (!L) {
                ...
                if (!I(o.value) && a && a.value === o.value) return;
              }
          ...
          for (
            ...
            for (
              ...
              (o = u[l]) &&
                ...
                ("__data__" in o && (a.__data__ = o.__data__), (s[l] = a));
      ...
      var tt = function(t) {
        ...
        rt = function(t) {
          ...
          for (
            ...
            for (
              var o, a = e[i], u = a.length, c = (r[i] = []), s = 0;
              s < u;
              ++s
            )
        ...
        ot = function() {
          return new ze(this._enter || this._groups.map(it), this._parents);
        };
      function at(t, e) {
      ...
      function lt(t, e, n, r, i, o, a) {
        ...
        for (u = 0; u < f; ++u)
          (c = e[u]) &&
            ((d[u] = s = ct + a.call(c, c.__data__, u, e)),
            s in l ? (i[u] = c) : (l[s] = c));
        for (u = 0; u < h; ++u)
          (s = ct + a.call(t, o[u], u, o)),
            (c = l[s])
              ? ((r[u] = c), (c.__data__ = o[u]), (l[s] = null))
              : (n[u] = new at(t, o[u]));
        for (u = 0; u < f; ++u) (c = e[u]) && l[d[u]] === c && (i[u] = c);
      }
      var ft = function(t, e) {
          if (!t)
            return (
          ...
          for (
            ...
            var l = r[s],
              f = i[s],
              h = f.length,
              d = t.call(l, l && l.__data__, s, r),
              p = d.length,
              v = (u[s] = new Array(p)),
              g = (a[s] = new Array(p)),
              m = (c[s] = new Array(h));
            n(l, f, v, g, m, d, e);
            for (var y, b, A = 0, w = 0; A < p; ++A)
              if ((y = v[A])) {
                A >= w && (w = A + 1);
                while (!(b = g[w]) && ++w < p);
                y._next = b || null;
          ...
          return (a = new ze(a, r)), (a._enter = u), (a._exit = c), a;
        },
        ht = function() {
          return new ze(this._exit || this._groups.map(it), this._parents);
        },
        dt = function(t, e, n) {
          var r = this.enter(),
            i = this,
        ...
        gt = function(t) {
          ...
          for (
            ...
            for (
              var a, u = n[o], c = u.length, s = (i[o] = new Array(c)), l = 0;
              l < c;
              ++l
            )
              (a = u[l]) && (s[l] = a);
      ...
      var zt = function(t, e, n) {
        return arguments.length > 1
          ? this.each(
              (null == e ? Lt : "function" === typeof e ? It : Pt)(
                t,
                e,
                null == n ? "" : n
              )
      ...
      var Vt = function(t, e) {
        return arguments.length > 1
          ? this.each(
              (null == e ? Dt : "function" === typeof e ? Gt : Yt)(t, e)
            )
          : this.node()[t];
      };
      function Ft(t) {
      ...
      function Ht(t, e) {
        return function() {
          (e.apply(this, arguments) ? Kt : qt)(this, t);
        };
      }
      Jt.prototype = {
        add: function(t) {
      ...
      var Wt = function(t, e) {
        ...
        if (arguments.length < 2) {
          var r = Xt(this.node()),
            i = -1,
            o = n.length;
          while (++i < o) if (!r.contains(n[i])) return !1;
          return !0;
        }
        return this.each(("function" === typeof e ? Ht : e ? Qt : Zt)(n, e));
      };
      function $t() {
        this.textContent = "";
      }
      ...
      var ne = function(t) {
        return arguments.length
          ? this.each(null == t ? $t : ("function" === typeof t ? ee : te)(t))
      ...
      var ae = function(t) {
        return arguments.length
          ? this.each(null == t ? re : ("function" === typeof t ? oe : ie)(t))
          : this.node().innerHTML;
      };
      function ue() {
      ...
      function fe(t) {
        return function() {
          var e = this.ownerDocument,
            n = this.namespaceURI;
          return n === _t && e.documentElement.namespaceURI === _t
            ? e.createElement(t)
      ...
      var ge = function(t, e) {
        var n = "function" === typeof t ? t : de(t),
          r = null == e ? ve : "function" === typeof e ? e : H(e);
        return this.select(function() {
      ...
      function je(t, e, n) {
        var r = ke.hasOwnProperty(t.type) ? Ee : Oe;
      ...
      var Ne = function(t, e, n) {
        var r,
          ...
          a = o.length;
        if (!(arguments.length < 2)) {
          for (u = e ? je : Re, null == n && (n = !1), r = 0; r < a; ++r)
            this.each(u(o[r], e, n));
          return this;
        }
      ...
      var Pe = function(t, e) {
          return this.each(("function" === typeof e ? Le : Be)(t, e));
        },
        Ie = [null];
      function ze(t, e) {
      ...
      function Ue() {
        return new ze([[document.documentElement]], Ie);
      }
      ...
      Ve.prototype = Ge.prototype = {
        ...
        on: function(t, e) {
          ...
          if (!(arguments.length < 2)) {
            ...
            while (++o < a)
              if ((n = (t = i[o]).type)) r[n] = Je(r[n], t.name, e);
              else if (null == e) for (n in r) r[n] = Je(r[n], t.name, null);
            return this;
          }
          while (++o < a)
            if ((n = (t = i[o]).type) && (n = Xe(r[n], t.name))) return n;
        },
        copy: function() {
          var t = {},
            e = this._;
      ...
      function ln() {
        ...
        var t,
          e = Ke;
        while (e)
          (t = en - e._time) >= 0 && e._call.call(null, t), (e = e._next);
        --Ze;
      }
      function fn() {
        (en = (tn = rn.now()) + nn), (Ze = He = 0);
        try {
          ln();
        } finally {
          (Ze = 0), dn(), (en = 0);
      ...
      function pn(t) {
        if (!Ze) {
          ...
          var e = t - en;
          e > 24
            ? (t < 1 / 0 && (He = setTimeout(fn, t - rn.now() - nn)),
              We && (We = clearInterval(We)))
            : (We || ((tn = rn.now()), (We = setInterval(hn, $e))),
              (Ze = 1),
              on(fn));
        }
      }
      cn.prototype = sn.prototype = {
        ...
        restart: function(t, e, n) {
          ...
          (n = (null == n ? an() : +n) + (null == e ? 0 : +e)),
            this._next ||
              qe === this ||
              (qe ? (qe._next = this) : (Ke = this), (qe = this)),
            (this._call = t),
            (this._time = n),
            pn();
        },
      ...
      var vn = function(t, e, n) {
        ...
        gn = Qe("start", "end", "cancel", "interrupt"),
        mn = [],
        yn = 0,
        bn = 1,
        An = 2,
      ...
      function Rn(t, e, n) {
        ...
        function a(o) {
          var s, l, f, h;
          if (n.state !== bn) return c();
          for (s in i)
            if (((h = i[s]), h.name === n.name)) {
              if (h.state === wn) return vn(a);
              h.state === xn
                ? ((h.state = _n),
                  h.timer.stop(),
          ...
          if (
            (vn(function() {
              n.state === wn &&
                ((n.state = xn), n.timer.restart(u, n.delay, n.time), u(o));
            }),
            (n.state = An),
            ...
            for (
              n.state = wn, r = new Array((f = n.tween.length)), s = 0, l = -1;
              s < f;
              ++s
            )
        ...
        function u(e) {
          var i =
              e < n.duration
                ...
                : (n.timer.restart(c), (n.state = kn), 1),
            o = -1,
            a = r.length;
          while (++o < a) r[o].call(t, i);
          n.state === kn &&
            (n.on.call("end", t, t.__data__, n.index, n.group), c());
        }
        function c() {
          for (var r in ((n.state = _n), n.timer.stop(), delete i[e], i))
            return;
          delete t.__transition;
        }
        (i[e] = n), (n.timer = sn(o, 0, n.time));
      }
      var jn,
        Nn,
        Cn,
      ...
      function Dn(t) {
        return "none" === t
          ...
          : (jn ||
            ...
            (jn.style.transform = t),
            (t = Cn.getComputedStyle(Nn.appendChild(jn), null).getPropertyValue(
              "transform"
            )),
            Nn.removeChild(jn),
            (t = t.slice(7, -1).split(",")),
            Un(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]));
      }
      function Yn(t) {
        return null == t
          ? zn
          : (Tn ||
              (Tn = document.createElementNS(
      ...
      function Gn(t, e, n, r) {
        ...
        return function(e, n) {
          ...
          return (
            (e = t(e)),
            (n = t(n)),
            o(e.translateX, e.translateY, n.translateX, n.translateY, r, i),
            a(e.rotate, n.rotate, r, i),
            ...
            function(t) {
              var e,
                n = -1,
                o = i.length;
              while (++n < o) r[(e = i[n]).i] = e.x(t);
              return r.join("");
            }
          );
        };
      }
      var Vn = Gn(Dn, "px, ", "px)", "deg)"),
        Fn = Gn(Yn, ", ", ")", ")");
      function Xn(t, e) {
        var n, r;
        return function() {
      ...
      var Kn = function(t, e) {
        ...
        if (((t += ""), arguments.length < 2)) {
          for (
            var r, i = Mn(this.node(), n).tween, o = 0, a = i.length;
            o < a;
            ++o
          )
        ...
        return this.each((null == e ? Xn : Jn)(n, t, e));
      };
      function qn(t, e, n) {
        var r = t._id;
        return (
      ...
      var Wn = 0.7,
        ...
        nr = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*",
        rr = /^#([0-9a-f]{3,8})$/,
        ir = new RegExp("^rgb\\(" + [tr, tr, tr] + "\\)$"),
        or = new RegExp("^rgb\\(" + [nr, nr, nr] + "\\)$"),
        ar = new RegExp("^rgba\\(" + [tr, tr, tr, er] + "\\)$"),
        ur = new RegExp("^rgba\\(" + [nr, nr, nr, er] + "\\)$"),
        cr = new RegExp("^hsl\\(" + [er, nr, nr] + "\\)$"),
        sr = new RegExp("^hsla\\(" + [er, nr, nr, er] + "\\)$"),
        lr = {
          aliceblue: 15792383,
      ...
      function pr(t) {
        ...
        return (
          ...
          (e = rr.exec(t))
            ...
            : (e = cr.exec(t))
            ? kr(e[1], e[2] / 100, e[3] / 100, 1)
            : (e = sr.exec(t))
            ? kr(e[1], e[2] / 100, e[3] / 100, e[4])
            : lr.hasOwnProperty(t)
            ? vr(lr[t])
            : "transparent" === t
            ? new br(NaN, NaN, NaN, 0)
            : null
        );
      }
      function vr(t) {
        return new br((t >> 16) & 255, (t >> 8) & 255, 255 & t, 1);
      }
      function gr(t, e, n, r) {
        return r <= 0 && (t = e = n = NaN), new br(t, e, n, r);
      }
      function mr(t) {
        return (
          t instanceof Hn || (t = pr(t)),
          t ? ((t = t.rgb()), new br(t.r, t.g, t.b, t.opacity)) : new br()
        );
      }
      function yr(t, e, n, r) {
        return 1 === arguments.length
          ? mr(t)
          : new br(t, e, n, null == r ? 1 : r);
      }
      function br(t, e, n, r) {
      ...
      function _r(t) {
        if (t instanceof Er) return new Er(t.h, t.s, t.l, t.opacity);
        if ((t instanceof Hn || (t = pr(t)), !t)) return new Er();
        ...
        return (
          u
            ? ((a =
              ...
              (a *= 60))
            : (u = c > 0 && c < 1 ? 0 : a),
          new Er(a, u, c, t.opacity)
        );
      }
      function Sr(t, e, n, r) {
        return 1 === arguments.length
          ? _r(t)
          : new Er(t, e, n, null == r ? 1 : r);
      }
      function Er(t, e, n, r) {
          ...
          Zn(Hn, {
            brighter: function(t) {
              return (
                ...
                new br(this.r * t, this.g * t, this.b * t, this.opacity)
              );
            },
            darker: function(t) {
              return (
                (t = null == t ? Wn : Math.pow(Wn, t)),
                new br(this.r * t, this.g * t, this.b * t, this.opacity)
              );
            },
            rgb: function() {
        ...
        Qn(
          ...
          Zn(Hn, {
            brighter: function(t) {
              return (
                (t = null == t ? $n : Math.pow($n, t)),
                new Er(this.h, this.s, this.l * t, this.opacity)
              );
            },
            darker: function(t) {
              return (
      ...
      function Br(t) {
        return 1 === (t = +t)
          ? Lr
          : function(e, n) {
              return n - e ? Tr(e, n, t) : Nr(isNaN(e) ? n : e);
            };
      }
      function Lr(t, e) {
        var n = e - t;
        return n ? Cr(t, n) : Nr(isNaN(t) ? e : t);
      }
      var Pr = (function t(e) {
        var n = Br(e);
        function r(t, e) {
          var r = n((t = yr(t)).r, (e = yr(e)).r),
            i = n(t.g, e.g),
            o = n(t.b, e.b),
            a = Lr(t.opacity, e.opacity);
          return function(e) {
            return (
              (t.r = r(e)),
              (t.g = i(e)),
      ...
      var Gr = function(t, e) {
          var n,
            r,
            i,
            o = (zr.lastIndex = Ur.lastIndex = 0),
            a = -1,
            u = [],
            c = [];
          (t += ""), (e += "");
          while ((n = zr.exec(t)) && (r = Ur.exec(e)))
            (i = r.index) > o &&
      ...
      var Zr = function(t, e) {
        ...
        return this.attrTween(
          t,
          "function" === typeof e
            ? (n.local ? Qr : qr)(n, r, qn(this, "attr." + t, e))
            : null == e
            ? (n.local ? Xr : Fr)(n)
            : (n.local ? Kr : Jr)(n, r, e)
        );
      ...
      var ei = function(t, e) {
        ...
        var r = Et(t);
        return this.tween(n, (r.local ? $r : ti)(r, e));
      };
      function ni(t, e) {
        return function() {
      ...
      var ii = function(t) {
        var e = this._id;
        return arguments.length
          ? this.each(("function" === typeof t ? ni : ri)(e, t))
          : Mn(this.node(), e).delay;
      };
      function oi(t, e) {
        return function() {
      ...
      var ui = function(t) {
        var e = this._id;
        return arguments.length
          ? this.each(("function" === typeof t ? oi : ai)(e, t))
          : Mn(this.node(), e).duration;
      };
      function ci(t, e) {
        if ("function" !== typeof e) throw new Error();
        return function() {
            ...
            for (var c, s = r[u], l = s.length, f = 0; f < l; ++f)
              if ((c = s[f])) {
                for (
                  ...
                  (h = d[v]) && Sn(h, e, n, v, d, p);
                o.push(d), a.push(c);
              }
          return new Ui(o, a, e, n);
        },
        bi = De.prototype.constructor,
        Ai = function() {
      ...
      function wi(t, e) {
        ...
        return function() {
          var o = Ut(this, t),
            a = (this.style.removeProperty(t), Ut(this, t));
          return o === a
            ? null
            : o === n && a === r
            ? i
      ...
      function _i(t, e, n) {
        ...
        return function() {
          var a = Ut(this, t),
            ...
            c = u + "";
          return (
            null == u && (this.style.removeProperty(t), (c = u = Ut(this, t))),
            a === c
              ? null
              : a === r && c === i
              ? o
      ...
      function Si(t, e) {
        ...
        return function() {
          var c = On(this, t),
            s = c.on,
            l = null == c.value[a] ? o || (o = xi(e)) : void 0;
          (s === n && i === l) || (r = (n = s).copy()).on(u, (i = l)),
            (c.on = r);
        };
      }
      var Ei = function(t, e, n) {
        var r = "transform" === (t += "") ? Vn : Vr;
        return null == e
          ? this.styleTween(t, wi(t, r)).on("end.style." + t, xi(t))
          : "function" === typeof e
          ? this.styleTween(t, _i(t, r, qn(this, "style." + t, e))).each(
              Si(this._id, t)
            )
          : this.styleTween(t, ki(t, r, e), n).on("end.style." + t, null);
      };
      function Oi(t, e, n) {
        return function(r) {
      ...
      var Ri = function(t, e, n) {
        ...
        if ("function" !== typeof e) throw new Error();
        return this.tween(r, Mi(t, e, null == n ? "" : n));
      };
      function ji(t) {
        return function() {
          this.textContent = t;
      ...
      function Xi(t, e) {
        var n;
        while (!(n = t.__transition) || !(n = n[e]))
          if (!(t = t.parentNode)) return (Fi.time = an()), Fi;
        return n;
      }
      var Ji = function(t) {
        var e, n;
        ...
        for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
          for (var a, u = r[o], c = u.length, s = 0; s < c; ++s)
            (a = u[s]) && Sn(a, t, e, s, u, n || Xi(a, e));
        return new Ui(r, this._parents, t, e);
      };
      (De.prototype.interrupt = Ln), (De.prototype.transition = Ji);
      var Ki = Math.PI,
        qi = 2 * Ki,
        Qi = 1e-6,
        Zi = qi - Qi;
      ...
      Hi.prototype = Wi.prototype = {
          ...
          if (null === this._x1)
            ...
            if (Math.abs(l * u - c * s) > Qi && i) {
              var h = n - o,
                ...
                m = Math.sqrt(f),
                y =
                  i * Math.tan((Ki - Math.acos((p + f - v) / (2 * g * m))) / 2),
                b = y / m,
                A = y / g;
              Math.abs(b - 1) > Qi &&
                (this._ += "L" + (t + b * s) + "," + (e + b * l)),
                (this._ +=
                  "A" +
                  i +
                  "," +
        ...
        arc: function(t, e, n, r, i, o) {
          ...
          null === this._x1
            ? (this._ += "M" + c + "," + s)
            : (Math.abs(this._x1 - c) > Qi || Math.abs(this._y1 - s) > Qi) &&
              (this._ += "L" + c + "," + s),
            n &&
              (f < 0 && (f = (f % qi) + qi),
              f > Zi
      ...
      function ao(t) {
        ...
        return (
          ...
          (a.x = function(t) {
            return arguments.length
              ? ((r = "function" === typeof t ? t : eo(+t)), a)
              : r;
          }),
          (a.y = function(t) {
            return arguments.length
              ? ((i = "function" === typeof t ? t : eo(+t)), a)
              : i;
          }),
      ...
      var so = 3,
        ...
        fo = function(t) {
          return "string" === typeof t
            ? new ze([[document.querySelector(t)]], [document.documentElement])
            : new ze([[t]], Ie);
        };
      function ho() {
      ...
      var po = function() {
        ...
        vo = function(t) {
          var e = t.document.documentElement,
            n = fo(t).on("dragstart.drag", po, !0);
          "onselectstart" in e
            ? n.on("selectstart.drag", po, !0)
            : ((e.__noselect = e.style.MozUserSelect),
              (e.style.MozUserSelect = "none"));
        };
      function go(t, e) {
        var n = t.document.documentElement,
          r = fo(t).on("dragstart.drag", null);
        e &&
          (r.on("click.drag", po, !0),
          setTimeout(function() {
      ...
      var _o = function(t, e) {
          ...
          if (h < Ao)
            (r = Math.log(s / a) / mo),
              (n = function(t) {
                return [i + t * l, o + t * f, a * Math.exp(mo * t * r)];
              });
          else {
            var d = Math.sqrt(h),
              p = (s * s - a * a + bo * h) / (2 * a * yo * d),
              v = (s * s - a * a - bo * h) / (2 * s * yo * d),
            ...
            (r = (m - g) / mo),
              (n = function(t) {
                var e = t * r,
                  n = wo(g),
                  u = (a / (yo * d)) * (n * ko(mo * e + g) - xo(g));
                return [i + u * l, o + u * f, (a * n) / wo(mo * e + g)];
              });
          }
        ...
        Oo = function(t) {
          var e = So();
          return e.changedTouches && (e = e.changedTouches[0]), Eo(t, e);
        },
        Mo = function(t, e, n) {
          arguments.length < 3 && ((n = e), (e = So().changedTouches));
          for (var r, i = 0, o = e ? e.length : 0; i < o; ++i)
            if ((r = e[i]).identifier === n) return Eo(t, r);
          return null;
        },
        Ro = function(t) {
          return function() {
      ...
      No.prototype = {
        constructor: No,
        scale: function(t) {
          return 1 === t ? this : new No(this.k * t, this.x, this.y);
        },
        translate: function(t, e) {
          return (0 === t) & (0 === e)
            ? this
            : new No(this.k, this.x + this.k * t, this.y + this.k * e);
        },
        apply: function(t) {
      ...
      var Co = new No(1, 0, 0);
      function To(t) {
        while (!t.__zoom) if (!(t = t.parentNode)) return Co;
        return t.__zoom;
      }
      function Bo() {
        _e.stopImmediatePropagation();
      ...
      function Uo() {
        return (
          -_e.deltaY * (1 === _e.deltaMode ? 0.05 : _e.deltaMode ? 1 : 0.002)
        );
      }
      function Do() {
      ...
      var Go = function() {
          ...
          function g(t, e) {
            return (
              (e = Math.max(u[0], Math.min(u[1], e))),
              e === t.k ? t : new No(e, t.x, t.y)
            );
          }
          function m(t, e, n) {
            var r = e[0] - n[0] * t.k,
              i = e[1] - n[1] * t.k;
            return r === t.x && i === t.y ? t : new No(t.k, r, i);
          }
          function y(t) {
            ...
            t.on("start.zoom", function() {
              ...
              .tween("zoom", function() {
                var t = this,
                  ...
                  h = l(
                    s.invert(u).concat(c / s.k),
                    f.invert(u).concat(c / f.k)
                  );
                return function(t) {
                  if (1 === t) t = f;
                  else {
                    var e = h(t),
                      n = c / e[2];
                    t = new No(n, u[0] - e[0] * n, u[1] - e[1] * n);
                  }
                  o.zoom(null, t);
                };
              });
          ...
          function x() {
            if (n.apply(this, arguments)) {
              var t = A(this, arguments),
                ...
                r = Math.max(
                  u[0],
                  Math.min(u[1], e.k * Math.pow(2, o.apply(this, arguments)))
                ),
                a = Oo(this);
              if (t.wheel)
                ...
                if (e.k === r) return;
                (t.mouse = [a, e.invert(a)]), Bn(this), t.start();
              }
              Lo(),
                (t.wheel = setTimeout(s, d)),
                t.zoom(
                  "mouse",
                  i(m(g(e, r), t.mouse[0], t.mouse[1]), t.extent, c)
                );
            }
            function s() {
              (t.wheel = null), t.end();
          ...
          function k() {
            ...
            function s() {
              ...
              t.zoom(
                "mouse",
                i(
                  m(t.that.__zoom, (t.mouse[0] = Oo(t.that)), t.mouse[1]),
                  t.extent,
                  c
                )
              );
          ...
          function _() {
            if (n.apply(this, arguments)) {
              var t = this.__zoom,
                e = Oo(this),
                o = t.invert(e),
                a = t.k * (_e.shiftKey ? 0.5 : 2),
                u = i(m(g(t, a), e, o), r.apply(this, arguments), c);
              Lo(),
                s > 0
                  ? fo(this)
                      .transition()
          ...
          function S() {
            if (n.apply(this, arguments)) {
              var e,
                ...
                a = _e.touches,
                u = a.length,
                c = A(this, arguments, _e.changedTouches.length === u);
              for (Bo(), r = 0; r < u; ++r)
                (i = a[r]),
                  (o = Mo(this, a, i.identifier)),
                  (o = [o, this.__zoom.invert(o), i.identifier]),
                  c.touch0
                    ? c.touch1 ||
                      c.touch0[2] === o[2] ||
                      ((c.touch1 = o), (c.taps = 0))
                    : ((c.touch0 = o), (e = !0), (c.taps = 1 + !!t));
              t && (t = clearTimeout(t)),
                e &&
                  (c.taps < 2 &&
          ...
          function E() {
            if (this.__zooming) {
              var e,
                ...
                s = u.length;
              for (
                Lo(), t && (t = clearTimeout(t)), a.taps = 0, e = 0;
                e < s;
                ++e
              )
                (n = u[e]),
                  (r = Mo(this, u, n.identifier)),
              ...
              if (((n = a.that.__zoom), a.touch1)) {
                ...
                (n = g(n, Math.sqrt(p / v))),
                  (r = [(l[0] + h[0]) / 2, (l[1] + h[1]) / 2]),
                  (o = [(f[0] + d[0]) / 2, (f[1] + d[1]) / 2]);
              } else {
                if (!a.touch0) return;
                (r = a.touch0[0]), (o = a.touch0[1]);
              }
              a.zoom("touch", i(m(n, r, o), a.extent, c));
            }
          }
          function O() {
            if (this.__zooming) {
              ...
              if (
                ...
                var a = fo(this).on("dblclick.zoom");
                a && a.apply(this, arguments);
              }
            }
          }
          return (
            (v.transform = function(t, e, n) {
              var r = t.selection ? t.selection() : t;
              r.property("__zoom", zo),
                t !== r
                  ? b(t, e, n)
            ...
            (v.scaleTo = function(t, e, n) {
              v.transform(
                ...
                function() {
                  ...
                  return i(m(g(o, s), a, u), t, c);
                },
                n
              );
            }),
            (v.translateBy = function(t, e, n) {
            ...
            (v.translateTo = function(t, e, n, o) {
              v.transform(
                t,
                function() {
                  var t = r.apply(this, arguments),
            ...
            (w.prototype = {
              ...
              emit: function(t) {
                Ce(new jo(v, t, this.that.__zoom), f.apply, f, [
                  t,
                  this.that,
                  this.args
                ]);
            ...
            (v.wheelDelta = function(t) {
              return arguments.length
                ? ((o = "function" === typeof t ? t : Ro(+t)), v)
                : o;
            }),
            (v.filter = function(t) {
              return arguments.length
                ? ((n = "function" === typeof t ? t : Ro(!!t)), v)
                : n;
            }),
            (v.touchable = function(t) {
              return arguments.length
                ? ((a = "function" === typeof t ? t : Ro(!!t)), v)
                : a;
            }),
            (v.extent = function(t) {
              return arguments.length
            ...
            (v.clickDistance = function(t) {
              return arguments.length ? ((p = (t = +t) * t), v) : Math.sqrt(p);
            }),
            v
          );
        },
        Vo = function(t) {
          return "string" === typeof t
            ? new ze([document.querySelectorAll(t)], [document.documentElement])
            : new ze([null == t ? [] : t], Ie);
        },
        Fo = function(t) {
          return function() {
      ...
      function Xo(t, e, n, r, i, o, a, u, c, s) {
        (this.target = t),
          (this.type = e),
          (this.subject = n),
          (this.identifier = r),
      ...
      var Zo = function() {
        ...
        function d() {
          if (!r && i.apply(this, arguments)) {
            var a = b("mouse", o.apply(this, arguments), Oo, this, arguments);
            a &&
              (fo(_e.view)
        ...
        function v() {
          fo(_e.view).on("mousemove.drag mouseup.drag", null),
            go(_e.view, n),
            po(),
            c.mouse("end");
        }
        function g() {
          if (i.apply(this, arguments)) {
            var t,
              ...
              a = n.length;
            for (t = 0; t < a; ++t)
              (e = b(n[t].identifier, r, Mo, this, arguments)) &&
                (ho(), e("start"));
          }
        }
        function m() {
          var t,
            ...
            n = _e.changedTouches,
            r = n.length;
          for (t = 0; t < r; ++t) (e = c[n[t].identifier]) && (po(), e("drag"));
        }
        function y() {
          var t,
            e,
        ...
        function b(t, e, n, r, i) {
          ...
          if (
            Ce(
              new Xo(h, "beforestart", o, t, l, d[0], d[1], 0, 0, p),
              function() {
                return (
                  null != (_e.subject = o = a.apply(r, i)) &&
        ...
        return (
          (h.filter = function(t) {
            return arguments.length
              ? ((i = "function" === typeof t ? t : Fo(!!t)), h)
              : i;
          }),
          (h.container = function(t) {
            return arguments.length
              ? ((o = "function" === typeof t ? t : Fo(t)), h)
              : o;
          }),
          (h.subject = function(t) {
            return arguments.length
              ? ((a = "function" === typeof t ? t : Fo(t)), h)
              : a;
          }),
          (h.touchable = function(t) {
            return arguments.length
              ? ((u = "function" === typeof t ? t : Fo(!!t)), h)
              : u;
          }),
          (h.on = function() {
      ...
      function la(t, e) {
        ...
        while ((n = s.pop()))
          if (
            (c && (n.value = +n.data.value), (i = e(n.data)) && (a = i.length))
          )
            for (n.children = new Array(a), o = a - 1; o >= 0; --o)
              s.push((r = n.children[o] = new va(i[o]))),
                (r.parent = n),
                (r.depth = n.depth + 1);
        return u.eachBefore(pa);
      }
      function fa() {
        return la(this).eachBefore(da);
      }
      function ha(t) {
        return t.children;
      }
      ...
      function ya(t) {
        ...
        function i() {
          const t = n("nodeSize"),
            e = n("spacing");
          return class n extends la.prototype.constructor {
            constructor(t) {
              super(t);
            }
            copy() {
        ...
        function a(t, e, n) {
          const r = (e, i) => {
            ...
            const a = n(e) || [];
            return (
              (o.children = 0 === a.length ? null : a.map(t => r(t, o))),
              o.children &&
                Object.assign(
                  o,
                  o.children.reduce(
        ...
        return (
          Object.assign(r, {
            ...
            hierarchy(t, n) {
              const r = "undefined" === typeof n ? e.children : n;
              return a(i(), t, r);
            },
            dump(t) {
              const e = n("nodeSize"),
      ...
      const ba = (t, e = 0) => (
          ...
          (t.children || []).reduce(
            (e, n) => {
              const [r, i] = e;
              ba(n, t.y + t.ySize);
              const o = (0 === r ? n.lExt : n.rExt).bottom;
              0 !== r && xa(t, r, i);
              const a = ja(o, r, i);
              return [r + 1, a];
            },
        ...
        Aa = (t, e, n) => {
          ...
          return (
            ...
            (t.prelim = 0),
            (t.x = n + t.relX),
            (t.children || []).forEach(e => Aa(e, r, t.x)),
            t
          );
        },
        wa = t => {
        ...
        xa = (t, e, n) => {
          ...
          while (o && u) {
            ...
            const r =
              ...
              o.spacing(u);
            (r > 0 || (r < 0 && s)) &&
              ((c += r), ka(i, r), _a(t, e, n.index, r)),
              (s = !1);
            const l = o.bottom,
              f = u.bottom;
            l <= f && ((o = Ea(o)), o && (a += o.relX)),
              l >= f && ((u = Sa(u)), u && (c += u.relX));
          }
          !o && u ? Oa(t, e, u, c) : o && !u && Ma(t, e, o, a);
        },
        ka = (t, e) => {
        ...
        Sa = t => (t.hasChildren ? t.firstChild : t.lThr),
        Ea = t => (t.hasChildren ? t.lastChild : t.rThr),
        Oa = (t, e, n, r) => {
          const i = t.firstChild,
            o = i.lExt,
            a = t.children[e];
          o.lThr = n;
          const u = r - n.relX - i.lExtRelX;
          (o.relX += u),
            (o.prelim -= u),
            (i.lExt = a.lExt),
            (i.lExtRelX = a.lExtRelX);
        },
        Ma = (t, e, n, r) => {
          const i = t.children[e],
            o = i.rExt,
            a = t.children[e - 1];
          o.rThr = n;
          const u = r - n.relX - i.rExtRelX;
          (o.relX += u),
            (o.prelim -= u),
            (i.rExt = a.rExt),
            (i.rExtRelX = a.rExtRelX);
        },
        Ra = t => {
          if (t.hasChildren) {
      ...
      n("7db0"), n("d81d"), n("a434");
      var Na = function(t) {
          var e = (t.length / 6) | 0,
            n = new Array(e),
            r = 0;
          while (r < e) n[r] = "#" + t.slice(6 * r, 6 * ++r);
          return n;
        },
        Ca = Na(
      ...
      function Da(t, e) {
        var n;
        "0" !== t.id && ((n = e || Ia("".concat((za += 1)))), (t.color = n));
        var r = t.children,
          i = t._children;
        if (r) for (var o = 0; o < r.length; o += 1) Da(r[o], n);
        if (i) for (var a = 0; a < i.length; a += 1) Da(i[a], n);
      }
      function Ya(t) {
        t.size = Pa(t.name, "0" === t.id);
        var e = t.children,
          n = t._children;
        if (e) for (var r = 0; r < e.length; r += 1) Ya(e[r]);
        if (n) for (var i = 0; i < n.length; i += 1) Ya(n[i]);
      }
      function Ga(t) {
        var e = t.children,
          n = t._children,
        ...
        if (((r.left = t.left), e)) {
          var i = e.length;
          r.children = new Array(i);
          for (var o = 0; o < i; o++) r.children[o] = Ga(e[o]);
        }
        if (n) {
          var a = n.length;
          r._children = new Array(a);
          for (var u = 0; u < a; u++) r._children[u] = Ga(n[u]);
        }
        return r;
      }
      function Va(t) {
        ...
        if (
          ...
          console.error(
            "[Mindmap warn]: Error in data: data.children and data._children cannot contain data at the same time"
          );
        else {
          if (n)
            for (var i = 0; i < n.length; )
              "del" === n[i].id
                ? n.splice(i, 1)
                : (Va(n[i], "".concat(e, "-").concat(i)), (i += 1));
          if (r)
            for (var o = 0; o < r.length; )
              "del" === r[o].id
                ? r.splice(o, 1)
                : (Va(r[o], "".concat(e, "-").concat(o)), (o += 1));
        }
      }
      function Fa(t) {
        ...
        var n = t.children,
          r = t._children;
        if (n) for (var i = 0; i < n.length; i += 1) Fa(n[i], t.left);
        if (r) for (var o = 0; o < r.length; o += 1) Fa(r[o], t.left);
      }
      var Xa = (function() {
          function t(e, n) {
            l(this, t),
            ...
            var r = this.data,
              i = r.children,
              o = r._children;
            if (i) for (var a = 0; a < i.length; a += 1) Fa(i[a], i[a].left);
            if (o) for (var u = 0; u < o.length; u += 1) Fa(o[u], o[u].left);
          }
          return (
            h(t, [
              {
              ...
              },
              {
                ...
                value: function(t, e) {
                  if (t.length > 0) {
                    var n = this.find(t);
                    return (
                      n && ((n.name = e), (n.size = Pa(e, "0" === n.id))), n
                    );
                  }
                }
              },
                ...
                value: function(t) {
                  for (
                    ...
                    var r = e[n],
                      i = this.find(r);
                    !i ||
                      (i._children && 0 !== i._children.length) ||
                      ((i._children = i.children), (i.children = []));
                  }
                }
              },
              {
                ...
                value: function(t) {
                  for (
                    ...
                    !i ||
                      ...
                      ((i.children = i._children), (i._children = []));
                  }
                }
              },
              {
                ...
                value: function(t) {
                  for (
                    var e, n = Array.isArray(t) ? t : [t], r = 0;
                    r < n.length;
                    r++
                  ) {
                    var i = n[r],
                    ...
                    if (o.length >= 2) {
                      ...
                      a &&
                        u &&
                        (u.children && (u.children[~~a].id = "del"),
                        (void 0 === e ||
                          e.id.split("-").length > u.id.split("-").length) &&
                          (e = u));
                    }
                  }
                  e && Va(e, e.id);
              ...
              },
              {
                key: "add",
                value: function(t, e) {
                  console.log(t, e, "adddd");
                  if (t.length > 0) {
                    var n = this.find(t);
                    if (n) {
                      var r;
                      ((null === (r = n._children) || void 0 === r
                        ? void 0
                        : r.length) || 0) > 0 &&
                      ...
                      return (
                        ...
                        Da(i, n.color || Ia("".concat((za += 1)))),
                        Va(
                          i,
                          "".concat(n.id, "-").concat(n.children.length - 1)
                        ),
                        (i.left = n.left),
                        Ya(i),
                        i
                  ...
                  if (t.length > 2) {
                    ...
                    if (i && a) {
                      var u = JSON.parse(JSON.stringify(e)),
                        c = a.children;
                      return (
                        c && (c.splice(~~i + n, 0, u), (u.left = c[~~i].left)),
                        Da(u, a.color || Ia("".concat((za += 1)))),
                        Va(a, a.id),
                        Ya(u),
                        u
                      );
                    ...
                    if (e) {
                      if (e.length > 2) {
                        var r = this.find(e),
                          ...
                          u = this.find(a),
                          c = e.split("-").pop();
                        if (o && c && r && u && u.children) {
                          var s = ~~o,
                            l = ~~c;
                          s < l && (l -= 1);
                          var f = u.children.splice(s, 1)[0];
                          f.left !== r.left && Fa(f, r.left),
                            u.children.splice(l + n, 0, f),
                            Va(u, u.id);
                        }
                      }
                    } else {
                  ...
                  if (e.length > 2 && t.length > 0 && t !== e) {
                    ...
                    if (i && a && n) {
                      var u,
                        ...
                        f,
                        h =
                          null === (u = a.children) || void 0 === u
                            ? void 0
                            : u.splice(~~i, 1)[0];
                      if (h)
                        ((null === (c = n.children) || void 0 === c
                          ? void 0
                          : c.length) || 0) > 0
                          ? null === (s = n.children) ||
                            void 0 === s ||
                            s.push(h)
                          : ((null === (l = n._children) || void 0 === l
                              ? void 0
                              : l.length) || 0) > 0
                          ? null === (f = n._children) ||
                            void 0 === f ||
                            f.push(h)
                          : (n.children = [h]),
                          Da(h, "0" === t ? Ia("".concat((za += 1))) : n.color),
                          Fa(h, "0" === t ? h.left : n.left),
                          Va(n, n.id),
                          Va(a, a.id);
                    }
                  }
          ...
          return (
            h(t, [
              ...
              },
              {
                ...
                value: function() {
                  return this.canUndo
                    ? ((this.cursor -= 1), this.snapshots[this.cursor])
                    : null;
                }
              },
              {
              ...
              },
              {
                key: "move",
                value: function(t) {
                  if (this.snapshots.length > t)
                    return (this.cursor = t), this.snapshots[this.cursor];
                }
              },
              {
                key: "clear",
                value: function() {
                  (this.cursor = -1), (this.snapshots = []);
                }
              },
              {
                key: "canUndo",
      ...
      function Qa(t, e, n, r) {
        for (
          var i = 0;
          i < (null === t || void 0 === t ? void 0 : t.length);
          i += 1
        ) {
          var o = t[i];
          e.length > 3 && "#" === e[0]
            ? ((n += "- ".concat(o.name, "\n")),
              o.children && (n = Qa(o.children, "  -", n, "  ")))
            : ((n += "".concat(e, " ").concat(o.name, "\n")),
              o.children && (n = Qa(o.children, "".concat(r).concat(e), n, r)));
        }
        return n;
      }
      function Za(t) {
      ...
      var Ha,
        ...
        tu = (function(t) {
          ...
          return (
            h(n, [
              {
                key: "onKeyboardChanged",
                value: function(t) {
                  this.makeKeyboard(t);
                }
              },
              {
                key: "onShowNodeAddChanged",
                value: function(t) {
                  this.makeNodeAdd(t);
                }
              },
              {
                key: "onDraggableChanged",
                value: function(t) {
                  this.makeDrag(t);
                }
              },
              {
                key: "onContextMenuChanged",
                value: function(t) {
                  this.makeContextMenu(t);
                }
              },
              {
                key: "onXSpacingChanged",
                value: function() {
                  Wa.resize(), this.updateMmdata(), this.updateMindmap();
                }
              },
              {
                key: "onYSpacingChanged",
                value: function() {
                  this.updateMindmap();
                }
              },
              {
                key: "onZoomableChanged",
                value: function(t) {
                  this.makeZoom(t);
                }
              },
              {
                key: "getViewPos",
                value: function(t) {
                  var e = this.$refs.svg.getBoundingClientRect(),
                    n = _e,
                    r = n.pageX,
                    i = n.pageY,
                    o = e.left + window.pageXOffset,
              ...
              },
              {
                key: "updateMmdata",
                value: function(t) {
                  t && (Wa.data = JSON.parse(JSON.stringify(t))),
                    this.toRecord &&
                      this.history.record(JSON.parse(JSON.stringify(Wa.data))),
                    this.updateMindmap(),
                    (this.toUpdate = !1),
                    this.$emit("change", [Wa.getSource()]);
                }
              },
              {
                key: "init",
                value: function() {
                  var t = this;
                  (this.mindmapSvg = fo(this.$refs.svg)),
                    (this.mindmapG = fo(this.$refs.content)),
                    this.mindmapG.style("opacity", 0),
                    (this.dummy = fo(this.$refs.dummy)),
                    this.makeKeyboard(this.keyboard),
                    this.mindmapSvg.on("contextmenu", function() {
                      _e.preventDefault();
                    }),
                    (this.mindmapSvgZoom = this.zoom
                      .on("zoom", function() {
                        t.mindmapG.attr("transform", _e.transform);
                      })
                      .filter(function() {
                        return (
                          ((_e.ctrlKey && "mousedown" !== _e.type) ||
                            (t.spaceKey && "wheel" !== _e.type)) &&
                          !_e.button
                        );
                      })
                      .scaleExtent([0.1, 8])),
              ...
              },
              {
                key: "makeNodeAdd",
                value: function(t) {
                  var e = this.mindmapG.selectAll("foreignObject"),
                    n = this.mindmapG.selectAll(".gButton");
                  if (t) {
                    var r = this.mouseLeave,
                      i = this.mouseEnter,
                      o = this.gBtnClick;
                    e.on("mouseenter", i).on("mouseleave", r),
                      n
                        .on("mouseenter", i)
                        .on("mouseleave", r)
                        .on("mousedown", o);
                  } else
                    e.on("mouseenter", null).on("mouseleave", null),
                      n
                        .on("mouseenter", null)
                        .on("mouseleave", null)
                        .on("mousedown", null);
              ...
              },
              {
                ...
                value: function(t) {
                  var e = this.mindmapG.selectAll("foreignObject");
                  t
                    ? e.on("contextmenu", this.fObjectRightClick)
                    : e.on("contextmenu", null);
                }
              },
              {
                key: "makeDrag",
                value: function(t) {
                  var e = this.mindmapG,
                    n = this.dragged,
                    r = this.fObjMousedown,
                    i = this.dragended,
                    o = e.selectAll("foreignObject"),
                    a = Zo().container(function(t, e, n) {
                      var r;
                      return null === (r = n[e].parentNode) || void 0 === r
                        ? void 0
                        : r.parentNode;
                    });
                  t
                  ...
                  t
                    ? n
                        ...
                        .on("wheel.zoom", function() {
                          ...
                          var s = To(e.$refs.svg);
                          if (r) {
                            var l = e.$refs.svg.getBoundingClientRect(),
                              f = l.left + window.pageXOffset,
                              h = l.top + window.pageYOffset,
                              d = s.k - 0.02 * o;
                            i.scaleTo(n, d, [u - f, c - h]);
                          } else i.translateBy(n, -a, -o);
                        })
                    : n.on(".zoom", null);
                }
              },
              ...
              },
              {
                ...
                value: function(t, e) {
                  ...
                  (n.download = e), (n.style.display = "none");
                  var r = new Blob([t]);
              ...
              },
              {
                ...
                value: function() {
                  ...
                  switch (this.selectedOption) {
                    case 0:
                      (e = JSON.stringify(t, null, 2)), (n += ".json");
                      break;
                    case 2:
                      (e = $a(t)), (n += ".md");
                      break;
                            ...
                            case 0:
                              return (
                                ...
                                Di()
                                  .end()
                                  .then(function() {
                                    e.mindmapSvg.call(e.zoom.translateTo, 0, 0);
                                  })
                              );
                            case 2:
                            case "end":
                            ...
                            case 0:
                              return (
                                ...
                                Di()
                                  .end()
                                  .then(function() {
                                    var t = e.$refs.content.getBBox(),
                                      n = e.$refs.mindmap,
                                      r = n.offsetWidth / t.width,
                                      i = n.offsetHeight / t.height,
                                      o = Math.min(r, i);
                                    e.mindmapSvg
                                      .transition(e.easePolyInOut)
                                      .call(e.zoom.scaleTo, o);
                                  })
                              );
                            case 2:
                            case "end":
                ...
                value: function(t, e) {
                  var n =
                    arguments.length > 2 && void 0 !== arguments[2]
                      ...
                      : 0;
                  this.toRecord = !0;
                  var r = Wa.insert(t.id, e, n);
                  return this.updateMmdata(), r;
                }
              },
              {
                key: "move",
              ...
              },
              {
                key: "del",
                value: function(t) {
                  if (((this.toRecord = !0), Array.isArray(t))) {
              ...
              },
              {
                ...
                value: function() {
                  var t = _e,
                    e = t.key;
                  if (
                    (" " !== e || this.spaceKey || (this.spaceKey = !0),
                    t.metaKey)
                  )
                    "z" === e
                      ? (_e.preventDefault(), this.undo())
                      : "y" === e && (_e.preventDefault(), this.redo());
                  else {
                    var n = fo("#selectedNode"),
                      r = n.node();
                    // 2021.01.20 修改
                    if (this.editable && r) {
                      var i = n.data()[0],
                      ...
                      switch (e) {
                        case "Tab":
                          ...
                          c && this.editNew(c, o + 1, u);
                          break;
                        case "Enter":
                          if ((_e.preventDefault(), u === this.$refs.content)) {
                            var s = this.add(a, {
                              name: ""
                            });
                            s && this.editNew(s, o + 1, u);
                          } else {
                            var l = this.insert(
                              a,
                              {
                            ...
                            l && this.editNew(l, o, u);
                          }
                          break;
                        case "Backspace":
                          _e.preventDefault(), this.del(a);
                          break;
                        default:
                          break;
                      }
              ...
              },
              {
                ...
                value: function() {
                  ...
                  null === (t = window.getSelection()) ||
                    ...
                    t.removeAllRanges();
                  var r = n.innerText || "";
                  this.mindmapG.select("g#editing").each(function(t, n, i) {
                    i[n].removeAttribute("id");
                    var o = e.updateName(t.data, r);
                    o && e.$emit("updateNodeName", Wa.getSource(o.id), o.id);
                  }),
                    n.setAttribute("contenteditable", "false");
                }
              },
              {
                key: "removeSelectedId",
                value: function() {
                  var t = document.getElementById("selectedNode");
                  t &&
                    (t.setAttribute("__click__", "0"), t.removeAttribute("id"));
                }
              },
              {
                key: "selectNode",
                value: function(t) {
                  this.removeMultiSelected(),
                    "selectedNode" !== t.getAttribute("id") &&
                      (this.removeSelectedId(),
                      t.setAttribute("id", "selectedNode"));
                }
              },
              {
                key: "editNode",
                value: function(t) {
                  ...
                  if (!this.editable) {
                    ...
                    this.removeSelectedId(), t.setAttribute("id", "editing");
                    var e = fo(t)
                      .selectAll("foreignObject")
                      .filter(function(e, n, r) {
                        return r[n].parentNode === t;
                      });
                    this.focusNode(e),
                      e.select("div").attr("contenteditable", !0);
                    var n,
              ...
              },
              {
                key: "focusNode",
                value: function(t) {
                  var e = To(this.$refs.svg),
                    n = e.k,
                    r = t.node().getBoundingClientRect();
                  if (r) {
                    var i = this.$refs.svg.getBoundingClientRect(),
                      o = r.right - i.right,
                      a = r.bottom - i.bottom,
                      u = r.left - i.left,
                      c = r.top - i.top,
                      s = (o > 0 && o) || (u < 0 && u),
                      l = (a > 0 && a) || (c < 0 && c);
                    s && this.mindmapSvg.call(this.zoom.translateBy, -s / n, 0),
                      l &&
                        this.mindmapSvg.call(this.zoom.translateBy, 0, -l / n);
                  }
                }
              },
              {
                ...
                value: function(t, e, n) {
                  ...
                  Di()
                    ...
                    .then(
                      function() {
                        var i = fo(n)
                          .selectAll("g.node.depth_".concat(e))
                          .filter(function(e) {
              ...
              },
              {
                key: "fdivMouseDown",
                value: function() {
                  var t = _e.target.getAttribute("contenteditable");
                  "true" === t && _e.stopPropagation();
                }
              },
              {
                key: "fObjMousedown",
                value: function(t, e, n) {
                  var r = document.getElementById("editing"),
                    i = 0,
                    o = n[e].parentNode;
                  if (r && r !== o) {
                    var a = Vo("foreignObject")
                  ...
                  (r && !i) || this.selectNode(o);
                }
              },
              {
                key: "fObjectClick",
                value: function(t, e, n) {
                  var r = document.getElementById("selectedNode"),
                    i = this.dragFlag;
                  r &&
                    ("1" !== r.getAttribute("__click__") ||
                    n[e].parentNode !== r ||
                    document.activeElement === n[e].firstElementChild ||
                    i
                      ? (r.setAttribute("__click__", "1"),
                        i ||
                          this.$emit(
                            "click",
                            Wa.getSource(t.data.id),
                            t.data.id
                          ))
                      : (this.editNode(r), r.setAttribute("__click__", "0")));
                }
              },
              {
                key: "fObjectRightClick",
                value: function(t, e, n) {
                  this.$emit("contextMenu", Wa.getSource(t.data.id), t.data.id);
                  var r = this,
                    i = document.getElementById("selectedNode"),
                    o = document.getElementById("editing"),
                    a = n[e].parentNode,
                    u = function() {
                      var t = r.getViewPos();
                      (r.contextMenuX = t.left),
                        (r.contextMenuY = t.top),
                        (r.showContextMenu = !0),
                        r.clearSelection(),
                        setTimeout(function() {
                          r.$refs.menu.focus();
                  ...
                  if (a.classList.contains("multiSelectedNode")) {
                    var c = [];
                    this.mindmapG
                      .selectAll("g.multiSelectedNode")
                      .each(function(t, e, n) {
                        c.push(t.data);
                      });
                    var s =
                        c.filter(function(t) {
                          return (
                            t.children && t.children.length > 0 && this.editable
                          );
                        }).length > 0,
                      l =
                        c.filter(function(t) {
                    ...
                    // 2021.01.20 修改
                    setTimeout(() => {
                      (this.contextMenuItems[2].disabled = !s),
                        (this.contextMenuItems[3].disabled = !l),
                        (this.contextMenuItems[1].disabled = !this.editable),
                        (this.contextMenuItems[0].disabled = !this.editable),
                        (this.contextMenuTarget = c);
                    }, 300);
                    var t = this.getViewPos();
                    (this.contextMenuX = t.left),
                      (this.contextMenuY = t.top),
                    ...
                    a !== i && this.selectNode(a);
                    var f = t.data;
                    setTimeout(() => {
                      (this.contextMenuItems[2].disabled = !(
                        f.children &&
                        f.children.length > 0 &&
                        this.editable
                      )),
                        (this.contextMenuItems[3].disabled = !(
                          f._children &&
                          f._children.length > 0 &&
                          this.editable
                        )),
                        (this.contextMenuItems[1].disabled = !this.editable),
                        (this.contextMenuItems[0].disabled = !this.editable),
                        (this.contextMenuTarget = f);
                    }, 300);
                    var t = this.getViewPos();
                    (this.contextMenuX = t.left),
                      (this.contextMenuY = t.top),
              ...
              },
              {
                key: "gBtnClick",
                value: function(t, e, n) {
                  if ("1" === n[e].style.opacity) {
                    _e.stopPropagation();
                    var r = fo(n[e].parentNode).data()[0],
                      i = this.add(r.data, {
                        name: ""
                      });
                    this.mouseLeave(r, e, n),
                      i && this.editNew(i, r.depth + 1, n[e].parentNode);
                  }
                }
              },
              // 2021.01.20 修改
              {
                ...
                value: function(t) {
                  ...
                  this.$refs.svg.focus(), this.removeSelectedId();
                }
              },
              {
                key: "mouseLeave",
                value: function(t, e, n) {
                  n[e].className.baseVal.includes("gButton")
                    ? fo(n[e]).style("opacity", 0)
                    : Vo("g.gButton")
                        .filter(function(t, r, i) {
                          return i[r].parentNode === n[e].parentNode;
                        })
                        .style("opacity", 0);
                }
              },
              {
                ...
                value: function(t, e, n) {
                  var r,
                    i =
                      ((null === (r = t.data._children) || void 0 === r
                        ? void 0
                        : r.length) || 0) > 0;
                  i ||
                    (n[e].className.baseVal.includes("gButton")
                      ? fo(n[e]).style("opacity", 1)
                      : Vo("g.gButton")
                          .filter(function(t, r, i) {
                            return i[r].parentNode === n[e].parentNode;
                          })
              ...
              },
              {
                ...
                value: function(t, e, n) {
                  ...
                  fo(t)
                    ...
                    .attr(
                      "transform",
                      "translate(".concat(u, ",").concat(c, ")")
                    ),
                    fo("path#path_".concat(i.data.id))
                      .transition(s)
                      .attr("d", function(t) {
                        return o(t);
                      });
              ...
              },
              {
                key: "renewOffset",
                value: function(t, e, n) {
                  if (((t.px = e), (t.py = n), t.children))
                    for (var r = 0; r < t.children.length; r += 1) {
                      var i = t.children[r];
                      this.renewOffset(i, e, n);
                    }
                }
              },
              {
                key: "dragged",
                value: function(t, e, n) {
                  if (((this.dragFlag = !0), 0 !== t.depth)) {
                    var r = this.mindmapG,
                      i = this.xSpacing,
                      o = this.foreignX,
                      a = this.foreignY,
                      u = n[e].parentNode;
                    this.draggedNodeRenew(u, _e.y - t.y, _e.x - t.x, void 0, t);
                    var c = Oo(this.$refs.content),
                      s = c[0],
                      l = c[1];
                    r.selectAll("g.node")
                      .filter(function(t, e, n) {
                        return u !== n[e] && u.parentNode !== n[e];
                      })
                      .each(function(t, e, n) {
                        var r = n[e],
                          u = {
                        ...
                        l > u.x &&
                        l < u.x + u.height
                          ? r.setAttribute("id", "newParentNode")
                          : "newParentNode" === r.getAttribute("id") &&
              ...
              },
              {
                key: "dragback",
                value: function(t, e) {
                  this.draggedNodeRenew(e, 0, 0, 1e3, t);
                }
              },
              {
                key: "dragended",
                value: function(t, e, n) {
                  var r = this.dragback,
                    ...
                    o = this.fObjectClick,
                    a = n[e].parentNode,
                    u = document.getElementById("newParentNode");
                  if (u) {
                    ...
                    var s =
                        2 === t.data.id.split("-").length &&
                        ((t.y > 0 && t.y + t.py < 0) ||
                          (t.y < 0 && t.y + t.py > 0)),
                      l = s
                        ? function(e) {
                            return e.data.left !== t.data.left;
                          }
                        : function(e) {
                            return e.data.left === t.data.left;
                          },
                      f = fo(a.parentNode),
                      h = f
                        .selectAll("g.depth_".concat(t.depth))
                        .filter(function(t, e, n) {
                          return a !== n[e] && l(t);
                        });
                    if (h.nodes()[0]) {
                      ...
                      if (
                        (h.each(function(e, n, r) {
                          (e.x > t.x || s) &&
                            e.x > d.x1 &&
                            e.x < t.x + t.px &&
                            ((d.x1 = e.x), (d.b1 = e.data), (d.n1 = r[n])),
                            (e.x < t.x || s) &&
                              e.x < d.x0 &&
                              e.x > t.x + t.px &&
                              ((d.x0 = e.x), (d.b0 = e.data), (d.n0 = r[n]));
                        }),
                        d.b0 || d.b1)
                      ) {
                        var p,
                        ...
                        if (d.b0 && d.n0)
                          this.move(v, d.b0),
                            null === (p = a.parentNode) ||
                              void 0 === p ||
                              p.insertBefore(a, d.n0);
                        else if (d.b1 && d.n1) {
                          var g;
                          this.move(v, d.b1, 1),
                            null === (g = a.parentNode) ||
                              void 0 === g ||
                              g.insertBefore(a, d.n1.nextSibling);
                        }
                      } else r(t, a), o(t, e, n);
                    } else s ? this.move(t.data) : (r(t, a), o(t, e, n));
                  }
                  this.dragFlag = !1;
                }
              },
              {
                key: "removeMultiSelected",
                value: function() {
                  this.mindmapG
                    .selectAll("g.multiSelectedNode")
                    .each(function(t, e, n) {
                      n[e].classList.remove("multiSelectedNode");
                    });
                }
              },
              {
                key: "multiSelectStart",
                value: function() {
                  if ((this.removeSelectedId(), 0 === _e.button)) {
                    this.removeMultiSelected(), (this.multiSeleFlag = !0);
                    var t = this.mouse,
                      e = this.getViewPos,
                      n = e();
                    (t.x0 = n.left), (t.y0 = n.top);
                  }
                }
              },
              {
                ...
                value: function() {
                  if (this.multiSeleFlag) {
                    (this.showSelectedBox = !0), _e.preventDefault();
                    var t = this.mouse,
                      e = this.getViewPos,
                      n = e();
                    (t.x1 = n.left), (t.y1 = n.top);
                    var r = this.mindmapG,
                      i = this.seleBox;
                    r.selectAll("foreignObject").each(function(t, n, r) {
                      var o = r[n],
                        a = o.parentNode,
                        ...
                        c =
                          ...
                          u.top < i.bottom;
                      c
                        ? a.classList.add("multiSelectedNode")
                        : a.classList.remove("multiSelectedNode");
                    });
                  }
                }
              },
              {
                key: "multiSelectEnd",
                value: function() {
                  (this.multiSeleFlag = !1), (this.showSelectedBox = !1);
                  var t = this.mouse;
                  t.x0 = t.x1 = t.y0 = t.y1 = 0;
                }
              },
              {
                key: "updateMindmap",
              ...
              },
              {
                key: "gClass",
                value: function(t) {
                  return "depth_".concat(t.depth, " node");
                }
              },
              {
                key: "gTransform",
                value: function(t) {
                  return "translate(".concat(t.dy, ",").concat(t.dx, ")");
                }
              },
              {
                key: "foreignX",
              ...
              },
              {
                ...
                value: function(t) {
                  return (
                    ...
                    ("0" !== t.data.id ? -t.size[0] : -t.size[0] / 2)
                  );
                }
              },
              {
              ...
              },
              {
                ...
                value: function(t) {
                  var e;
                  return ((null === (e = t.data._children) || void 0 === e
                    ? void 0
                    : e.length) || 0) <= 0
                    ? "visible"
                    : "hidden";
              ...
              },
              {
                key: "pathId",
                value: function(t) {
                  return "path_".concat(t.data.id);
                }
              },
              {
                key: "pathClass",
                value: function(t) {
                  return "depth_".concat(t.depth);
                }
              },
              {
                key: "pathColor",
                value: function(t) {
                  return t.data.color || "white";
                }
              },
              {
                key: "path",
              ...
              },
              {
                ...
                value: function(t, e, n) {
                  ...
                  fo(n[e])
                    .selectAll(
                      "g".concat(
                        u[0] ? ".depth_".concat(u[0].depth, ".node") : ""
                      )
                    )
                    .data(u, r)
                    .join(i, o, a);
              ...
              },
              {
                ...
                value: function(t) {
                  var e = this.expand,
                    n = this.gEllTransform,
                    r = this.gClass,
                    i = this.gTransform,
                    o = this.updateNodeName,
                    a = this.divKeyDown,
                    u = this.foreignY,
                    c = this.gBtnTransform,
                    s = this.pathId,
                    l = this.pathClass,
                    f = this.pathColor,
                    h = this.path,
                    d = this.nest,
                    p = this.fdivMouseDown,
                    v = this.foreignX,
                    g = this.gBtnSide,
                    m = this.gBtnVisible,
                    y = this.gEllVisible,
                  ...
                  w
                    ...
                    .on("keydown", a)
                    .on("mousedown", p),
                    w.each(function(t, e, n) {
                      var r = new ResizeObserver(function(t) {
                        var n = t[0].target,
                          r = getComputedStyle(n).borderTopWidth,
                          i = getComputedStyle(n.parentNode).borderTopWidth,
                          o = parseInt(r, 10) + parseInt(i, 10) || 0;
                        A.filter(function(t, n) {
                          return e === n;
                        })
                          .attr("width", t[0].contentRect.width + 2 * o)
                          .attr("height", t[0].contentRect.height + 2 * o);
                      });
                      r.observe(n[e]);
                    });
                  var x = b
                  ...
                  var k = b
                    .append("g")
                    .attr("class", "gEllipsis")
                    .attr("transform", n)
                    .style("visibility", y)
                    .classed("show", function(t) {
                      var e;
                      return (
                        ((null === (e = t.data._children) || void 0 === e
                          ? void 0
                          : e.length) || 0) > 0
                      );
                    })
              ...
              },
              {
                key: "updateNode",
                value: function(t) {
                  var e = this.gEllTransform,
                    n = this.gClass,
                    r = this.gTransform,
                    i = this.easePolyInOut,
                    o = this.foreignY,
                    a = this.gBtnTransform,
                    u = this.pathId,
                    c = this.pathClass,
                    s = this.pathColor,
                    l = this.path,
                  ...
                  return (
                    ...
                    t
                      ...
                      .transition(i)
                      .attr("transform", r),
                    t.each(function(t, n, r) {
                      var d,
                        p = fo(r[n]),
                        v = p
                          .selectAll("foreignObject")
                          .filter(function(t, e, i) {
                            return i[e].parentNode === r[n];
                          })
                          .data([t])
                          .attr("x", h)
                          .attr("y", o);
                      v.select("div").text(t.data.name),
                        p
                          .select("path")
                          .filter(function(t, e, i) {
                            return i[e].parentNode === r[n];
                        ...
                        p.each(f);
                      var g =
                        ((null === (d = t.data._children) || void 0 === d
                          ? void 0
                          : d.length) || 0) > 0;
                      p.selectAll("g.gButton")
                        .filter(function(t, e, i) {
                          return i[e].parentNode === r[n];
                        })
                        .data([t])
              ...
              },
              {
                ...
                value: function() {
                  ...
                  e.selectAll(
                    "g".concat(
                      o[0] ? ".depth_".concat(o[0].depth, ".node") : ""
                    )
                  )
                    .data(o, t)
                    .join(n, r, i);
              ...
              },
              {
                ...
                value: function() {
                  var t = this.ySpacing,
                    ...
                    n = Wa.data.size[1] / 2,
                    r = e.hierarchy(Wa.data, function(t) {
                      var e;
                      return 1 === t.id.split("-").length
                  ...
                  e(r),
                    r.each(function(t) {
                      "0" !== t.data.id && (t.y = -t.y + n);
                    });
                  var i = e.hierarchy(Wa.data, function(t) {
                    var e;
                    return 1 === t.id.split("-").length
                      ? null === (e = t.children) || void 0 === e
                        ? void 0
                  ...
                  e(i),
                    ...
                    (i.children = r.children
                      ? i.children
                        ? i.children.concat(r.children)
                        : r.children
                      : i.children),
                    i.each(function(t) {
                      "0" !== t.data.id && (t.x += t.size[0] / 2),
                        (t.dx = t.x - (t.parent ? t.parent.x : 0)),
                        (t.dy = t.y - (t.parent ? t.parent.y : 0)),
                        (t.px = 0),
                        (t.py = 0);
                    }),
                    (this.root = i);
              ...
              },
              {
                ...
                value: function() {
                  if (window.getSelection) {
                    ...
                    null === t || void 0 === t || t.removeAllRanges();
                  }
                }
              },
              {
                ...
                value: function() {
                  ...
                  this.$watch(
                    ...
                    function(e) {
                      t.toUpdate
                        ? ((Wa = new Ja(e[0], t.getSize)), t.updateMmdata())
                        : (t.toUpdate = !0);
                    },
                    {
                      immediate: !0,
                        ...
                        function(t) {
                          while (1)
                            switch ((t.prev = t.next)) {
                              ...
                              case 7:
                                return (t.next = 9), this.fitContent();
                              case 9:
              ...
              },
              {
                ...
                get: function() {
                  return "stroke-width-"
                    .concat(this.strokeWidth, " ")
                    .concat(this.spaceKey && this.zoomable ? "grab" : "");
                }
              },
              {
                key: "optionTip",
      ...
      w([q(), x("design:type", Object)], tu.prototype, "width", void 0),
        w([q(), x("design:type", Object)], tu.prototype, "height", void 0),
        w(
          [
            q({
              default: 50
        ...
        w(
          [
            ...
            x(
              "design:type",
              "function" === typeof (Ha = "undefined" !== typeof Array && Array)
                ? Ha
                : Object
            )
          ],
      ...
      var iu = ru(nu, a, u, !1, null, null, null),
        ou = iu.exports;
      e["default"] = ou;
    },
    fc6a: function(t, e, n) {
