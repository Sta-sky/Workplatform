        ...
        <div class="allDetailBox">
          ...
          <div class="mainBox" v-if="!editNote">
            <div class="title">
              ...
              <span class="classify">{{ curRowData.classify }}</span>
              ...
              ></el-button>
              <el-button class="btn1" type="danger" @click="taskDel(curRowData)"
              ...
              >
                ...
                <el-timeline class="timeContent scrollStyle">
                  <el-timeline-item
                    ...
                    :key="i"
                    :timestamp="item.back_info"
                  >
                    <p class="timeTitle">
                      <span class="ttl">{{ item.user }}</span>
                      <span class="ttr" @click="versionBack(item)"
                        >版本回退</span
                      >
                    </p>
                  </el-timeline-item>
          ...
          <div class="mainBox" v-else>
            <div class="title">
              ...
              ></el-button>
              <el-button class="btn1" type="danger" @click="editNote = false"
                >取消编辑&nbsp;&nbsp;<i class="el-icon-delete"></i
              ></el-button>
            </div>
            <el-row
              :gutter="40"
              style="height:calc(100% - 120px);margin:0;padding:0 30px"
            >
              <el-form
                :model="editForm"
                style="height:100%"
              ...
              >
                ...
                <el-form-item prop="classify" label="笔记内容">
                  <el-radio-group v-model="editForm.classify" @change="typeChg">
                    <el-radio-button :label="0">MARKDOWN</el-radio-button>
                    <el-radio-button :label="1"
                      >&nbsp;&nbsp;&nbsp;富&nbsp;&nbsp;&nbsp;&nbsp;文&nbsp;&nbsp;&nbsp;&nbsp;本&nbsp;&nbsp;&nbsp;</el-radio-button
                    >
                  </el-radio-group>
                </el-form-item>
                <el-form-item prop="content" style="height:450px">
                  <tinymce
  ...
  methods: {
      ...
      treeList(data)
        .then(res => {
          if (res.data.success) {
            ...
            if (res.data.data.length > 0) this.noDataIs = false;
          } else {
      ...
      getTaskDetail()
        .then(res => {
          ...
          if (res.data.success) {
            ...
            this.$set(this.curRowData, "details", res.data.data.back);
    ...
    typeChg(val) {
      getTaskDetail()
        .then(res => {
          if (res.data.success) {
            this.$set(this.editForm, "content", this.editForm.content);
            if (val === 11) this.editForm = res.data.data;
          } else {
            this.$message.warning(res.data.info);
          }
        })
    ...
    sureEdit() {
      ...
      if (this.dialogType === 0) {
        ...
        // 版本回退
        var data = {
          note_id: this.dialogData.id,
          back_time: this.dialogData.time
        };
        noteBack(data)
          .then(res => {
            this.loadSureDel = false;
